    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-black to-gray-900">
      ...
      <section className="relative h-[500px] overflow-hidden">
        <div className="absolute inset-0">
          <video
            src="https://waedqmdlaupiusiqzipg.supabase.co/storage/v1/object/public/post-videos/hero_animation.mp4"
            autoPlay
            loop
            muted
            playsInline
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mb-8 animate-in slide-in-from-bottom duration-700 delay-200">
            Discover premium sports gear, exclusive deals, and expert-reviewed
            equipment
          </p>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
          {[
            ...
            <div
              key={i}
              className="bg-gray-900 rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 border border-gray-800"
            >
            ...
            {isLoading ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div
                    key={i}
                    className="bg-gray-900 rounded-xl p-4 animate-pulse shadow-lg border border-gray-800"
                  >
          ...
          <section className="container mx-auto px-4 sm:px-6 lg:px-8 pb-16">
            <div className="bg-gradient-to-r from-gray-800 to-black rounded-2xl p-8 md:p-12 text-center shadow-2xl border border-gray-700">
              ...
              <p className="text-gray-300 text-lg mb-6 max-w-2xl mx-auto">
                Subscribe to get the latest sports gear recommendations and
